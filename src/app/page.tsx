...
export default function Landing() {
  ...
  const features = [
    {
      icon: GitCommit,
      title: "Contextual Logs",
      desc: "Auto-sync activity from your IDE and AI chats. No more manual status updates."
    },
    {
      icon: Activity,
      title: "Chatter Ratio",
      desc: "Are you shipping or just chatting? Track exactly how much AI interaction translates to execution."
    },
    {
      icon: Target,
      title: "Model Observability",
      desc: "See how your project velocity changes as you switch between different AI models and weights."
    },
    {
      icon: Sparkles,
      title: "Pattern Detection",
      desc: "Identify if you're stuck in a 'Planning Loop' or entering a 'Deep Flow' state before you even realize it."
    }
  ];
      ...
      <main>
        ...
        <section className="py-24 px-6 max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Mike R.", role: "AI Builder", quote: "Finally, a tool that's not about useless charts. It's a mirror for my execution. Essential." }
            ].map((t, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
        ...
        <section className="py-24 max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              { q: "What is FounderOS?", a: "It's an operating system for solo AI builders. It helps you track your work, detect behavioral patterns, and build with more clarity." },
